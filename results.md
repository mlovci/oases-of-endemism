...
5. **Environmental vs. Biological Distinctiveness (The Oasis Niche)**:
    ...
    * *Extended Conclusion*: Our non-linear t-SNE manifold learning reveals that regional aquifer springs form a tight, completely isolated cluster in *environmental parameter space* itself. This demonstrates that their biological uniqueness is a direct product of their unique, rare environmental niche (the intersection of stable warm temperature, high depth, high bank cover, and coarse substrates), rather than overlapping generally with geothermal springs.
