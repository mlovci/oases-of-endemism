...
3.  **Global t-SNE Manifold & Environmental Driver Gradients**:
    - The t-SNE 2D mapping shows a clear separation of springs. Because t-SNE groups points based on local similarity in the high-dimensional space, the tight, localized cluster formed by Regional Aquifer oases demonstrates that their environmental conditions represent a highly specific, rare combination of conditions.
