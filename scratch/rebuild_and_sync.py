...
def main():
    ...
    # Copy walkthrough.md, results.md, methods.md, manuscript.md, and proposal.md back to brain root to keep them in sync
    for md_file in ["walkthrough.md", "results.md", "methods.md", "manuscript.md", "proposal.md"]:
